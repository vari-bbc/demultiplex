...
samp_dir=$(tail -n +20 $demux_dir/SampleSheet.csv | cut -f 9 -d",")
cd $demux_dir
echo "\\\\ Single-cell 10x demultiplexing ////"
echo "Run directory: $demux_dir"
echo "Sample Project directory: $samp_dir"
...
## e.g. ${samp_dir}:SHEH_20210629_10x
##cd ${flowcell} e.g. ${flowcell} HTHV7AFXY
cd ${demux_dir}${flowcell}/outs/fastq_path/${samp_dir}
